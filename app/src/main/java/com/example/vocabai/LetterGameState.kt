...
data class LetterTile(val id: String, val char: Char)
...
data class LetterGameState(
    ...
    fun reset(): LetterGameState =
        copy(availableTiles = selectedTiles + availableTiles, selectedTiles = emptyList())
...
private fun String.normalizedLetterTarget(): String = lowercase().filter { it in 'a'..'z' }
